...
This project assumes the use of the [IIC-OSIC-TOOLS](https://github.com/iic-jku/IIC-OSIC-TOOLS) all-in-one Docker image. To clone this repository, first ensure the Docker image is running and access the terminal within the image's home directory (/foss/designs) via the IIC-OSIC-TOOLS VNC. Then, execute the following command:
